...
if __name__ == "__main__":
    ...
    while True:
        # get user input
        input_term = input("\nWelcome! \n\nEnter a book title or enter exit to quit: ")
        ...
        if movies_choice.lower() == "yes":
            ...
            if df['title'].str.contains(book_title).any():
                print(f"{book_title} has been turned into a movie! Here is some information about the movie: \n")
